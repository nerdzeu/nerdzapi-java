    ...
    private class ReverseConversationHandler implements ConversationHandler {
        ...
        private class ReverseMessageFetcher extends ReverseConversation implements MessageFetcher {
            ...
            public int fetch(int limit) throws IOException, HttpException, ContentException {
                Pair<List<Message>, Boolean> fetched = ReverseConversationHandler.this.getMessagesAndCheck(this, this.mStart, limit);

                if (this.mMessageList == null) {

                }

                this.mStart = fetched.getLeft().size();
                this.mEndReached = fetched.getRight();
                return this.mStart;
            }
